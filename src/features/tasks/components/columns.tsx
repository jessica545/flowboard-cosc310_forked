...
export const columns: ColumnDef<Task>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <Badge variant={status} className="text-primary dark:text-inverse">{snakeCaseToTitleCase(status)}</Badge>;
      ...
      return (
        <TaskActions id={id} projectId={projectId}>
          <Button variant="ghost" className="size-8 p-0">
            <MoreVertical className="size-4 hover:color-[var(--primary)]" />
          </Button>
        </TaskActions>
      );
    },
