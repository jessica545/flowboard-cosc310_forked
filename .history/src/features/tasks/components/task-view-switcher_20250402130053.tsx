...
export const TaskViewSwitcher = ({ hideProjectFilter, forceProjectId }: TaskViewSwitcherProps) => {
    ...
    return (
        <Tabs defaultValue={view} onValueChange={setView} className="flex-1 w-full border-none rounded-lg">
            <TabsList className="w-full lg:w-auto mx-4">
                <TabsTrigger className="h-8 w-full lg:w-auto bg-tertiary mb-[-5px]" value="table">
                    Table
                </TabsTrigger>
                <TabsTrigger className="h-8 w-full lg:w-auto bg-tertiary mb-[-5px]" value="kanban">
                    Kanban
                </TabsTrigger>
            </TabsList>
