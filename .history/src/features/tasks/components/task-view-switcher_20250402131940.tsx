    ...
    return (
        <Tabs defaultValue={view} onValueChange={setView} className="flex-1 w-full border-none rounded-lg">
            <TabsList className="w-full lg:w-auto p-0 pl-2 overflow-hidden">
                <TabsTrigger className="h-8 w-[calc(100%+24px)] lg:w-[calc(auto+24px])] bg-tertiary px-6" value="table">
                    Table
                </TabsTrigger>
                <TabsTrigger className="h-8 w-full lg:w-auto-[+12px] bg-tertiary" value="kanban">
                    Kanban
                </TabsTrigger>
            </TabsList>
