...
export const TaskViewSwitcher = ({ hideProjectFilter, forceProjectId }: TaskViewSwitcherProps) => {
    ...
    return (
        <Tabs defaultValue={view} onValueChange={setView} className="flex-1 w-full border-none rounded-lg scrollbar">
            <TabsList className="w-full lg:w-auto p-0 pl-4 overflow-hidden mb-[-2px]">
