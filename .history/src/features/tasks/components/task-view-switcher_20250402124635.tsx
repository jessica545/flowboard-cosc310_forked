...
export const TaskViewSwitcher = ({ hideProjectFilter, forceProjectId }: TaskViewSwitcherProps) => {
    ...
    return (
        <Tabs defaultValue={view} onValueChange={setView} className="flex-1 w-full border-none bg-secondary rounded-lg">
            <div className="h-full flex flex-col overflow-auto p-4">
                <div className="flex flex-col gap-y-2 lg:flex-row justify-between items-center">
                    <TabsList className="w-full lg:w-auto bg-tertiary">
