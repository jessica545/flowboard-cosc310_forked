      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={isDisabled}
            className={cn(
              "px-4 py-2.5 bg-[var(--primary)] text-white rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all flex items-center justify-center min-w-[40px]",
        ...
        {errors.content && (
          <div className='text-sm text-destruct mt-1'>
