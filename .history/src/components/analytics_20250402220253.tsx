...
export const Analytics = ({ data }: AnalyticsProps) => {
  return (
    <ScrollArea className="border-1 rounded-lg w-full whitespace-nowrap shrink-0 mb-4">
      <div className="w-full flex flex-row [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
