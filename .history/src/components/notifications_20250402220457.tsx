...
export const Notifications = () => {
  ...
  return (
    <div className="flex items-center gap-x-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <Button 
        variant="secondary" 
        size="icon" 
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-80">
          ...
          <ScrollArea>
            ...
            <ScrollAreaViewport>
              <DropdownMenuSeparator />
              <div className="max-h-[300px] overflow-y-auto bg-tertiary border-1 rounded-md">
                {notifications.length > 0 ? (
            ...
            <Scrollbar orientation="vertical" className="h-5 [&>div]:bg-tertiary [&.div]:hover:bg-quaternary"/>
          </ScrollArea>
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
