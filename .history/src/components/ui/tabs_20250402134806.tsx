...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center rounded-lg scrollbar-rounded scrollbar-thin bg-transparent p-1 text-muted-foreground gap-x-2",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "px-4 mr-[-12px] first:ml-0 z-10",
      "bg-secondary-muted text-muted-foreground hover:bg-tertiary",
