...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "px-4 mr-[-12px] first:ml-0", // Reduced overlap
      // Visual styles
      "bg-secondary text-muted-foreground hover:bg-tertiary/80",
      "data-[state=active]:bg-tertiary data-[state=active]:text-foreground",
      // Trapezoid effect
      "before:absolute before:content-[''] before:left-0 before:bottom-0 before:w-3 before:h-full before:bg-inherit",
      "before:transform before:skew-x-[-12deg] before:origin-top-left rounded-md",
      "after:absolute after:content-[''] after:right-0 after:bottom-0 after:w-3 after:h-full after:bg-inherit",
      "after:transform after:skew-x-[12deg] after:origin-top-right rounded-md",
      className
    )}
    {...props}
  />
