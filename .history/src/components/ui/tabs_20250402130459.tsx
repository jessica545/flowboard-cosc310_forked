...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "clip-path-[polygon(0_0, 100%_0, 100%_100%, calc(100%_-_8px)_100%,4px_100%)]",
      "data-[state=active]:clip-path-[polygon(0_0, 100%_0, 100%_100%, calc(100%_-_4px)_100%,4px_100%)]",
      "mb-[-1px] mr-[-4px]",
      className
    )}
    {...props}
