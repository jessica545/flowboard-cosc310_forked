...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "text-hover inline-flex items-center justify-center whitespace-nowrap rounded-t-md rounded-b-none px-3 py-1 text-sm",
      "bg-secondary font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2",
