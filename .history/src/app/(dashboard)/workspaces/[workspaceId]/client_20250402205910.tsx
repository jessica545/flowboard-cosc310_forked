...
export const WorkspaceIdClient = async () => {
  ...
  return (
    <main className="min-h-screen bg-primary">
      <div className="flex flex-col gap-y-4 p-4 container mx-auto">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold text-primary">{workspace.name} Dashboard</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="bg-secondary p-4 rounded-lg shadow-none">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="space-y-3">
                {tasks.documents.slice(0, 5).map((task: { $id: string, name: string, project?: { name: string }, dueDate?: string }) => (
                  <Link 
                    ...
                    key={task.$id}
                    className="block hover:bg-primary p-2 rounded-md"
                  >
                ...
                <Link 
                  ...
                  className="block text-center py-2 text-sm text-[var(--primary)] hover:underline mt-2"
                >
                  Show All
                </Link>
              </div>
                ...
                {projects.documents.slice(0, 6).map((project: { $id: string, name: string, ImageUrl?: string }) => (
                  ...
                  >
                    <ProjectAvatar 
                      ...
                      className="h-8 w-8 bg-[var(--primary)]" 
                    />
        ...
        {/* Members Section */}
        <div className="bg-secondary p-4 rounded-lg shadow-none mt-4">
          <div className="flex items-center justify-between mb-4">
